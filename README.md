...
![Forecasting Business Impact — Projected $25M annual savings, 20% spike mitigation, 5.0-10.0x ROI](./screenshots/forecasting_business_impact_v2.png)

### Energy Demand Forecasting UI — Model Evaluation & Anomaly Detection
![Forecasting Solution UI — Demand over time chart with anomaly markers](./screenshots/forecasting_solution_ui_v2.png)

**🔴 Live Cloud Deployment:** [https://huggingface.co/spaces/vnicks179/TimeSeriesForecasting-demo](https://huggingface.co/spaces/vnicks179/TimeSeriesForecasting-demo)
...
| **Real-time Telemetry** | **High**: Directly interfaces with grid SCADA systems | **Medium**: Dependent on batch uploads to cloud API | **Build wins** for grid integration |
